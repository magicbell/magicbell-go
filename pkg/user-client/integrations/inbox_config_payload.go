...
type Theme struct {
	...
	Notification *ThemeNotification `json:"notification,omitempty"`
...
func (t *Theme) GetNotification() *ThemeNotification {
	if t == nil {
		return nil
	}
...
func (t *Theme) SetNotification(notification ThemeNotification) {
